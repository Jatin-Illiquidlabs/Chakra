...
FDamageEffectParams UDamageChakraGameplayAbility::MakeDamageEffectParamsFromClassDefaults(AActor* TargetActor,
...
float UDamageChakraGameplayAbility::GetDamageAtLevel() const
{
	return Damage.GetValueAtLevel(GetAbilityLevel());
}

FTaggedMontage UDamageChakraGameplayAbility::GetRandomTaggedMontageFromArray(const TArray<FTaggedMontage>& TaggedMontages) const
{
