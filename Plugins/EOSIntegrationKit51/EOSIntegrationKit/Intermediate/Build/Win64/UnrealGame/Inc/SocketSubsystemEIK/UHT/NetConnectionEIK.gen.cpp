...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNetConnectionEIK_Statics::ClassParams = {
		...
		0,
		0x001000ACu,
		METADATA_PARAMS(Z_Construct_UClass_UNetConnectionEIK_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UNetConnectionEIK_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_SocketSubsystemEIK_Private_NetConnectionEIK_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_SocketSubsystemEIK_Private_NetConnectionEIK_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetConnectionEIK, UNetConnectionEIK::StaticClass, TEXT("UNetConnectionEIK"), &Z_Registration_Info_UClass_UNetConnectionEIK, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetConnectionEIK), 1238213572U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_SocketSubsystemEIK_Private_NetConnectionEIK_h_3468236632(TEXT("/Script/SocketSubsystemEIK"),
		Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_SocketSubsystemEIK_Private_NetConnectionEIK_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_SocketSubsystemEIK_Private_NetConnectionEIK_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
