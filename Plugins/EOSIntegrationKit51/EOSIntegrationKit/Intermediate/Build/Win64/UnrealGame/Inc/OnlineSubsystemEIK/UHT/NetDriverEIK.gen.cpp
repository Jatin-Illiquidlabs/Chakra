...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNetDriverEIK_Statics::ClassParams = {
		...
		0,
		0x001000ACu,
		METADATA_PARAMS(Z_Construct_UClass_UNetDriverEIK_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UNetDriverEIK_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_OnlineSubsystemEIK_Private_NetDriverEIK_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_OnlineSubsystemEIK_Private_NetDriverEIK_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetDriverEIK, UNetDriverEIK::StaticClass, TEXT("UNetDriverEIK"), &Z_Registration_Info_UClass_UNetDriverEIK, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetDriverEIK), 865129586U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_OnlineSubsystemEIK_Private_NetDriverEIK_h_3308147535(TEXT("/Script/OnlineSubsystemEIK"),
		Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_OnlineSubsystemEIK_Private_NetDriverEIK_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Work_Projects_Chakra_Plugins_EOSIntegrationKit51_EOSIntegrationKit_Source_OnlineSubsystemEIK_Private_NetDriverEIK_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
